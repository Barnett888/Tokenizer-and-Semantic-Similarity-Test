...
np.savetxt("SYSTEM_OUT.answer-answer-Model5.txt", np.array(g1_score))
np.savetxt("SYSTEM_OUT.question-question-Model5.txt", np.array(g2_score))
np.savetxt("SYSTEM_OUT.headlines-Model5.txt", np.array(g3_score))
np.savetxt("SYSTEM_OUT.plagiarism-Model5.txt", np.array(g4_score))
np.savetxt("SYSTEM_OUT.postediting-Model5.txt", np.array(g5_score))
