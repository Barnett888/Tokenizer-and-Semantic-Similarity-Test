...
# load DistilBERT
nlp = spacy_sentence_bert.load_model('en_nq_distilbert_base_v1')
...
print("r5", r5)
"""
np.savetxt("SYSTEM_OUT.answer-answer-Model4.txt", np.array(g1_score))
np.savetxt("SYSTEM_OUT.question-question-Model4.txt", np.array(g2_score))
np.savetxt("SYSTEM_OUT.headlines-Model4.txt", np.array(g3_score))
np.savetxt("SYSTEM_OUT.plagiarism-Model4.txt", np.array(g4_score))
np.savetxt("SYSTEM_OUT.postediting-Model4.txt", np.array(g5_score))