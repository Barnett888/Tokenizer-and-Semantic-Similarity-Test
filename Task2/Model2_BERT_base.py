...
# load BERT base
nlp = spacy_sentence_bert.load_model('en_stsb_bert_base')
...
np.savetxt("SYSTEM_OUT.answer-answer-Model2.txt", np.array(g1_score))
np.savetxt("SYSTEM_OUT.question-question-Model2.txt", np.array(g2_score))
np.savetxt("SYSTEM_OUT.headlines-Model2.txt", np.array(g3_score))
np.savetxt("SYSTEM_OUT.plagiarism-Model2.txt", np.array(g4_score))
np.savetxt("SYSTEM_OUT.postediting-Model2.txt", np.array(g5_score))
